...
void setup() {
 ...
 /* Serial.println(xBee.enterATmode());
  ...
  String headerPRINT = "Pres 1 (atm)    Pres 2 (atm)    Temp 1 (C)    Temp 2 (C)    Time (s)    Input-Pressure (mBar)";  
...
void loop() {
  ...
  String dataPRINT = AtmSTR1 + "           " + AtmSTR2 + "           " + TempSTR1 + "        " + TempSTR2 + "        " + TimeSTR + "      " + inputPressure1+inputPressure2+inputPressure3+inputPressure4+inputPressure5+inputPressure6;
  String dataLOG = AtmSTR1 + "," + AtmSTR2 + "," + TempSTR1 + "," + TempSTR2 + "," + TimeSTR + "," + inputPressure1+inputPressure2+inputPressure3+inputPressure4+inputPressure5+inputPressure6;
