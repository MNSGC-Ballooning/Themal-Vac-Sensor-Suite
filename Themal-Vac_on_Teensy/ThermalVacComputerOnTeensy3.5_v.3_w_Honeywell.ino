...
#define switch_pin 38                 //Relay #1 Set Pin Definition
#define reset_pin 39                  //Relay #1 Reset Pin Definition
#define switch_pin_2 36               //Relay #2 Set Pin Definition
#define reset_pin_2 37                //Relay #2 Reset Pin Definition
...
void setup() {
 ...
 /* Serial.println(xBee.enterATmode());
  ...
  String headerPRINT = "Pres 1 (atm)    Pres 2 (atm)    Temp 1 (C)    Temp 2 (C)    Time (s)   Input-Pressure";  
  String headerLOG = "Pres 1 (atm),Pres 2 (atm),Temp 1 (C),Temp 2 (C),Time (s),Input-Pressure";
...
void loop() {
  ...
  String dataPRINT = AtmSTR1 + "           " + AtmSTR2 + "           " + TempSTR1 + "        " + TempSTR2 + "        " + TimeSTR;
  String dataLOG = AtmSTR1 + "," + AtmSTR2 + "," + TempSTR1 + "," + TempSTR2 + "," + TimeSTR;
